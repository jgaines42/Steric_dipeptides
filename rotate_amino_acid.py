    ...
    for psi_loop in range(0, 72):
        ...
        for chi1_loop in range(0, 3):
            ...
            if (total_E > 0 and (np.any(ind1) or np.any(ind2))):
                ...
                min_E = total_E
                # Rotate CH3 groups
                [min_E, Position_CH3] = rotate_CH3(Position_ppc.copy(), delta_term_CH3_1, delta_term_CH3_2, CH3_1_index, CH3_2_index, moveAtomID_CH3_1, moveAtomID_CH3_2, clash_list, radii_2, min_E, CH3_clash_list, CH3_radii_list)
                total_E = min_E
